...
<div class="row">
	<div class="col-md-4 col-md-offset-3">
		...
		<center><h2 style="margin-top:1px;">Système de Gestion de tâches</h2></center>
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  ...
			  <div class="form-group" ng-class="{'has-error': loginForm.password.$invalid && loginForm.password.$dirty, 'has-success': loginForm.password.$valid}">
			    <input type="password" class="form-control" placeholder="Mot de passe" name="admin_password" required/>
			  </div>
			  <button type="submit" name="login_btn" class="btn btn-info pull-right">Se connecter</button>
			</form>
		</div>
	</div>
</div>
