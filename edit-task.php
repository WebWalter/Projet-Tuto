        ...
        <div class="well well-custom">
          <div class="row">
            <div class="col-md-8 col-md-offset-2">
              <div class="well">
                <h3 class="text-center bg-primary" style="padding: 7px;">Modifier Tâche</h3><br>

                      <div class="row">
                        <div class="col-md-12">
                          <form class="form-horizontal" role="form" action="" method="post" autocomplete="off">
                            <div class="form-group">
			                    <label class="control-label col-sm-5">Titre de la tâche</label>
			                    <div class="col-sm-7">
			                  ...
			                  <div class="form-group">
			                    <label class="control-label col-sm-5">Description de la tâche</label>
			                    <div class="col-sm-7">
			                   ...
			                   <div class="form-group">
			                    ...
			                    <div class="col-sm-7">
			                      <select class="form-control" name="status" id="status">
			                      	<option value="0" <?php if($row['status'] == 0){ ?>selected <?php } ?>>Incomplet</option>
			                      	<option value="1" <?php if($row['status'] == 1){ ?>selected <?php } ?>>En cours</option>
			                      	<option value="2" <?php if($row['status'] == 2){ ?>selected <?php } ?>>Completer</option>
			                      </select>
			                    </div>
			                  </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                <button type="submit" name="update_task_info" class="btn btn-success-custom">Modifier</button>
                              </div>
                            </div>
                          </form> 
                        </div>
