...
/* -------------------------configurer_connexion_base de donné_avec_PDO---------------------- */
	...
	{ 
		...
		try{
			...
			$this->db = $connection; // connection établie
...
/* -------------changement_mdp_admin------------*/
	...
	public function admin_password_change($data, $id){
		...
		try{
			...
			// compare les anciens mot de passes 
