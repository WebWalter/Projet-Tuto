		...
		<div class="well" style="position:relative;top:20vh;">
			<form class="form-horizontal form-custom-login" action="" method="POST">
			  <div class="form-heading" style="background: orange;">
			    <h2 class="text-center">Veuillez changer de mot de passe</h2>
			  </div>
			  ...
			  <button type="submit" name="change_password_btn" class="btn btn-default pull-right">Changer Mot de passe</button>
			</form>
		</div>
	</div>
</div>
