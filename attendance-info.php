    ...
    <div class="row">
      <div class="col-md-12">
        <div class="well well-custom">
              ...
              ?>
                ...
                <div class="btn-group">
                  <form method="post" role="form" action="">
                    ...
                    <button type="submit" name="add_punch_in" class="btn btn-primary btn-lg rounded" >Commencer</button>
                  </form>
          ...
          <center><h3>Gérer la Présence</h3>  </center>
          <div class="gap"></div>
                ...
                <tr>
                  ...
                  <td>
                    <form method="post" role="form" action="">
                      ...
                      <button type="submit" name="add_punch_out" class="btn btn-danger btn-xs rounded" >Arrêter</button>
                    </form>
                  </td>
                <?php } ?>
                <?php if($user_role == 1){ ?>
